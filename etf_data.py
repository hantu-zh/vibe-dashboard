...
ETF_POOL = [
    ...
    ("512480", "sh512480", "半导体ETF",      "行业", 4),
    ("512760", "sh512760", "芯片ETF",        "行业", 4),
    ("512660", "sh512660", "军工ETF",        "行业", 4),
    ("512800", "sh512800", "银行ETF",        "行业", 4),
    ("512070", "sh512070", "非银ETF",        "行业", 4),
    ("512200", "sh512200", "房地产ETF",      "行业", 4),
    ("512010", "sh512010", "医药ETF",        "行业", 3),
    ("512170", "sh512170", "医疗ETF",        "行业", 4),
    ("512290", "sh512290", "生物医药ETF",    "行业", 3),
    ("512690", "sh512690", "白酒ETF",        "行业", 4),
    ("515170", "sh515170", "食品饮料ETF",    "行业", 4),
    ("512360", "sh512360", "计算机ETF",      "行业", 1),
    ("515030", "sh515030", "新能源车ETF",    "行业", 4),
    ("516160", "sh516160", "新能源ETF",      "行业", 4),
    ("515790", "sh515790", "光伏ETF",        "行业", 4),
    ("515050", "sh515050", "5GETF",          "行业", 4),
    ("512400", "sh512400", "有色金属ETF",    "行业", 4),
    ("512980", "sh512980", "传媒ETF",        "行业", 4),
    ("516950", "sh516950", "基建ETF",        "行业", 3),
    ("515880", "sh515880", "通信ETF",        "行业", 4),
    ("516150", "sh516150", "稀土ETF",        "行业", 4),
    ("515710", "sh515710", "光伏产业ETF",    "行业", 3),
    ("159903", "sz159903", "深证成指ETF",    "主题", 4),
    ("512510", "sh512510", "中证高铁ETF",    "主题", 3),
    ("515060", "sh515060", "国证芯片ETF",    "主题", 3),
    ("159992", "sz159992", "创新药ETF",      "主题", 3),
    ("516110", "sh516110", "汽车ETF",        "主题", 4),
    ("515950", "sh515950", "半导体材料ETF",  "主题", 2),
    ("159995", "sz159995", "芯片ETF(深)",    "主题", 4),
    ("512970", "sh512970", "证券ETF",        "主题", 1),
    ("515080", "sh515080", "新能车产业ETF",  "主题", 4),
    ("516390", "sh516390", "储能ETF",        "主题", 1),
    ("515220", "sh515220", "煤炭ETF",        "主题", 4),
    ("512560", "sh512560", "军工龙头ETF",    "主题", 4),
    ("159825", "sz159825", "农业ETF",        "主题", 4),
]
...
def fetch_etf_data():
    ...
    result = []
    for code, full_code, name, category, stars in ETF_POOL:
